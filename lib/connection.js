...
const { default: makeWASocket, Browsers, DisconnectReason, useMultiFileAuthState, fetchLatestBaileysVersion } = (await import("@adiwajshing/baileys")).default
...
const connectionOptions = { logger: pino({ level: 'silent' }), printQRInTerminal: true, auth: state, version, browser: Browsers.macOS('Desktop')}
...
async function connectionUpdate(update) {
    ...
    if (connection == 'open') { this.reply('573245088667@s.whatsapp.net',`Conectado`)
