...
let handler = async (m, { conn }) => {
  await sendContactArray(conn, m.chat, [
    ...
    [`5492622441096`, `${await conn.getName('5492622441096@s.whatsapp.net')}`, `🤝 Colaborador`, null],
     [`17163760512`, `${await conn.getName('17163760512@s.whatsapp.net')}`, `🤝 Colaborador`, null]], { key: { fromMe: false, participant: "0@s.whatsapp.net", ...(m.chat ? { remoteJid: "status@broadcast"} : {}) }, message: { contactMessage: { displayName: 'Varyon-Bot 24/7', vcard: `BEGIN:VCARD\nVERSION:3.0\nN:XL;0,;;;\nFN:0,\nitem1.TEL;waid=${m.sender.split("@")[0]}:${m.sender.split("@")[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`}}})
} 
handler.tags = ['main']
