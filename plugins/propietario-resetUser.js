let handler = async (m, { conn, text }) => {
   ...
   try { if (text) { var user = number + '@s.whatsapp.net' } else if (m.quoted.sender) { var user = m.quoted.sender } else if (m.mentionedJid) { var user = number + '@s.whatsapp.net' }} catch (e) {} finally {
...
handler.tags = ['owner']
handler.command = ['reset', 'reiniciaruser']
handler.admin = false
handler.rowner = true
