...
try { await conn.sendMessage(m.chat, { image: {url: link }, caption: captionn,}, { quoted: m }); m.react(done); if (global.ajustes.cmdRpg) return m.coin = true } catch { await m.react(error) }}
